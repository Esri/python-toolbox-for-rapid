'''-------------------------------------------------------------------------------
 Tool Name:   ConvertFlowlinesToCSVForCF.py
 Source Name: ConvertFlowlinesToCSVForCF
 Version:     ArcGIS 10.3
...
class ConvertFlowlineToCentroid(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Convert Flowlines to CSV for CF"
        self.description = ("Convert flowline to centroid in a csv valid for RAPID CF script")
    ...
    def getParameterInfo(self):
        ...
        param1 = arcpy.Parameter(name = 'out_centroid_file',
                                 displayName = 'Output centroid file',
                                 direction = 'Output',
                                 parameterType = 'Required',
                                 datatype = 'DEFile')
